...
public class DBAdapter {
  ...
  private static String TAG = "RAPID-DBAdapter";

  // private static final String DATABASE_NAME = "Rapid-DB.db";
  ...
  /**
   * Open the database if it exists or create it if it doesn't. Additionally checks if the table
  ...
  public DBAdapter(Context context, String dbName, String table, ArrayList<String> keys,
    ...
    DATABASE_CREATE = "CREATE TABLE IF NOT EXISTS " + DATABASE_TABLE + " (" + "_id"
        + " INTEGER PRIMARY KEY AUTOINCREMENT, " + keyString + ");";

    Log.v(TAG, DATABASE_CREATE);
    // Create a new Helper
    dbHelper = new myDBHelper(context, this.dbName, null, DATABASE_VERSION, DATABASE_TABLE,
        DATABASE_CREATE);
  }
  ...
  public long insertEntry(ArrayList<String> key, ArrayList<String> value) {
    ...
    Log.v(TAG, "Database Add: " + contentValues.toString());
  ...
  public Cursor getAllEntries(String[] columns, String selection, String[] selectionArgs,
    ...
    return db.query(DATABASE_TABLE, columns, selection, selectionArgs, groupBy, having,
        sortBy + " " + sortOption);
  }
  ...
  public Cursor getAllEntries(String[] columns, String selection, String[] selectionArgs,
    ...
    return db.query(DATABASE_TABLE, columns, selection, selectionArgs, groupBy, having,
        sortBy + " " + sortOption, limit);
  }


  /**
   * This is a function that should only be used if you know what you're doing. It is only here to
   * clear the appended test data. This clears out all data within the table specified when the
  ...
  /**
   * Helper Class for DBAdapter. Does the job of creating the database and checking if the database
   * needs an upgrade to new version depending on version number specified by DBAdapter.
   */
  private static class myDBHelper extends SQLiteOpenHelper {
    ...
    public myDBHelper(Context context, String name, CursorFactory factory, int version,
        String tableName, String creationString) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      ...
      Log.w("PowerDroid-Database", "Upgrading from version " + oldVersion + " to " + newVersion
