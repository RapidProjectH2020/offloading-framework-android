...
public class DatabaseQuery {
  ...
  // this(context, Constants.DEFAULT_DB_NAME);
  // }
   ...
   */
  public DatabaseQuery(Context context, String dbName) {
    ...
    database = new DBAdapter(context, dbName, LOG_TABLE, databaseKeys, databaseKeyOptions);
    database.open();
  ...
  /**
   * This method adds the row created by appending data to the database. The parameters constitute
   * one row of data.
   */
  public void addRow() {
   ...
   */
  public ArrayList<String> getData(String[] keys, String selection, String[] selectionArgs,
      String groupBy, String having, String sortBy, String sortOption) {

    ArrayList<String> list = new ArrayList<String>();
    Cursor results =
        database.getAllEntries(keys, selection, selectionArgs, groupBy, having, sortBy, sortOption);
  ...
  /**
   * Removes all the entries from the default table.
   * 
   * @return
   */
